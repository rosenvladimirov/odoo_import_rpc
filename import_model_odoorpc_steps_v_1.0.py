...
STEPS['step_3']['SEARCH_DOMAIN'] = [('id', 'not in', [5, 155])]
...
STEPS['step_8']['SEARCH_DOMAIN'] = [('categ_id', 'not in', [5, 140, 141, 149, 155, 135])]
...
STEPS['step_18']['SEARCH_DOMAIN'] = [('id', 'not in', [3793, 947, 948, 949, 1298, 1486, 1487, 1421, 1420, 1488, 1490]), ('product_tmpl_id', 'not in', [94560, 104971, 105259, 1409, 96641, 96575, 96435, 1540])]
...
STEPS['step_23']['FIELDS'] = ['sequence', 'manufacturer_pname', 'manufacturer_pref', 'manufacturer_purl', 'name',
                              'product_tmpl_id', 'manufacturer']
STEPS['step_23']['CHILD_FIELDS'] = []
STEPS['step_23']['SKIP_FIELDS'] = []
STEPS['step_23']['RELATIONAL_FIELDS'] = ['product_tmpl_id', 'manufacturer']
...
def process_relation_field(relation_record, field_name, relation_model):
    if field_name in relation_record:
        ...
        if isinstance(field_value, (list, tuple)) \
            ...
            elif field_name in ['partner_id', 'partner_invoice_id', 'partner_shipping_id', 'partner_doctor_id', 'manufacturer']:
                parent_id = odoo_dest.search_and_read(
                    'ir.model.data',
                    [
        ...
        while start:
            ...
            for record in source_data:
                ...
                existing_id = odoo_dest.search_and_read('ir.model.data',
                                                        ...
                                                        ['res_id'])
                if not existing_id and COMPARE_FILED and record[COMPARE_FILED]:
                ...
                # res_id = existing_id
                print('Record to save #:', processed_record, target_model)
...
if __name__ == '__main__':
    ...
    config.read("../conf/mainmcatbg.ini", "utf-8")
