...
STEPS['step_8']['SEARCH_DOMAIN'] = [('attribute_line_ids', '!=', False), ('id', '!=', 4034)]
...
STEPS['step_10']['SEARCH_DOMAIN'] = [('product_tmpl_id', 'not in', [4034, 3913, 4127, 8247, 8251, 8255, 8244, 8246, 8243, 8248, 8259])]
    ...
    for search_domain in SEARCH_DOMAINS:
        while start:
            ...
            for record in source_data:
                ...
                # res_id = existing_id
                print('Record to save #:', {k: v for k, v in processed_record.items() if k not in ['datas', 'image']}, target_model)
