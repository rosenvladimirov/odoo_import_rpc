...
STEPS['step_1']['SEARCH_DOMAIN'] = [('is_company', '=', False), ('id', 'not in', [3, 3311, 3492, 3567])]
...
STEPS['step_2']['SEARCH_DOMAIN'] = [('id', 'not in', [10, 9922])]
...
STEPS['step_8']['SEARCH_DOMAIN'] = [('id', 'not in', [119041, 119042])]
...
STEPS['step_10']['SEARCH_DOMAINS'] = [[('active', '=', True)]]
...
STEPS['step_27']['SEARCH_DOMAIN'] = []
STEPS['step_27']['SEARCH_DOMAINS'] = [[('id', '!=', False)]]
STEPS['step_27']['FIELDS'] = ['code', 'type', 'product_tmpl_id', 'product_id', 'product_qty', 'product_uom_id', 'sequence', 'company_id']
STEPS['step_27']['CHILD_FIELDS'] = []
STEPS['step_27']['SKIP_FIELDS'] = []
...
STEPS['step_28']['FIELDS'] = ['product_id', 'product_qty', 'product_uom_id', 'sequence', 'bom_id', 'attribute_value_ids', 'sequence']
